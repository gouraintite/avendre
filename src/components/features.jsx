                ...
                <div className="container mx-auto">
                        ...
                        <div className="w-full px-4">
                            <div className="mx-auto mb-6 max-w-[510px] text-center lg:mb-12">
                                ...
                                <p className="text-body-color text-base">
                                    Decouvre ce qu' Avendre t'offres et vois a quel point c'est fun !
                                </p>
                            </div>
                        </div>
                    </div>
                    <div className="-mx-4 flex flex-wrap">
                        <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                            <div
                                className="mb-8 rounded-[20px] bg-white p-10 shadow-md hover:shadow-xl hover:rotate-6 ease-in-out duration-300 md:px-7 xl:px-10"
                            >
                                <div
                                ...
                                <h4 className="text-dark mb-3 text-xl font-semibold">Applicaton légère</h4>
                                <p className="text-body-color">
                                    Telecharger Avendre en quelques secondes même si tu surfes à faible débit.
                                </p>
                            </div>
                        </div>
                        <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                            <div
                                ...
                                <p className="text-body-color">
                                    L'appli est d'abord nyanga! <br />
                                    Simple d'usage et 100% du 237.
                                </p>
                            </div>
                        </div>
                        <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                            <div
                                ...
                                <h4 className="text-dark mb-3 text-xl font-semibold">Essentielle et directe</h4>
                                <p className="text-body-color">
                                    Même la mater du village peut utiliser Avendre. Vend et achete en 2-3 clicks.
                                </p>
                            </div>
                        </div>
                    </div>
